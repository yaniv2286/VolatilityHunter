...
**Deterministic Quantitative Trading System | v8.0 Total Market Crucible | Power Stock Dual-Exit Architecture | Hedge Fund Portfolio Aggregator**
...
## 🚀 Current Version: v8.0 Total Market Crucible (Phase 5 Complete)
...
### **Power Stock Dual-Exit Strategy**
1. **Entry Screening**: 5-Gate system (CAGR > 15%, SMA 200 trend, Stochastic 32-80, Volume momentum, Blueprint crossover)
2. **Daily Promotion Check**: Monitor Power Stock promotion triggers during holding periods
3. **Dynamic Exit Logic**: Standard vs Power Stock exit conditions based on current state
...
│   ├── crucible_engine.py        # Legacy backtesting
│   └── prepare_tv_import.py      # TradingView export
├── 📂 scripts/                   # v8.0 Portfolio Aggregator
...
│   └── tv_export_full.csv        # Crucible results (TradingView ready)
├── 📂 docs/                      # Documentation
│   ├── README.md                  # This file
...
**VolatilityHunter v8.0 Total Market Crucible** - Phase 5 Complete | Power Stock Dual-Exit Architecture | Hedge Fund Portfolio Aggregator 🎯
