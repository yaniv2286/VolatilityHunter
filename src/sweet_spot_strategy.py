...
class SweetSpotStrategy:
    ...
    def analyze_stock_sweet_spot(self, ticker: str, df: pd.DataFrame, 
        ...
        try:
            ...
            base_analysis = analyze_stock_v7_2(ticker, df)
            ...
            return analyze_stock_v7_2(ticker, df)
    ...
    def _add_sweet_spot_analysis(self, ticker: str, df: pd.DataFrame, 
        ...
        enhanced_score = self._calculate_enhanced_score(
            base_analysis, pattern_score, time_score, spread_score
        )
    ...
    def _calculate_enhanced_score(self, base_analysis: Dict, pattern_score: float, 
                                time_score: float, spread_score: float) -> float:
        """
        ...
        try:
            ...
            weights = {
                'base': 1.0 - self.pattern_weight,  # Remaining weight for base strategy
                'pattern': self.pattern_weight * 0.4,  # 40% of pattern weight
                'time': self.pattern_weight * 0.3,    # 30% of pattern weight
                'spread': self.pattern_weight * 0.3   # 30% of pattern weight
            }
    ...
    def check_exit_conditions_sweet_spot(self, ticker: str, df: pd.DataFrame, 
        ...
        try:
            ...
            base_exit = check_exit_conditions_v7_2(ticker, df, position)
