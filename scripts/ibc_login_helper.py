#!/usr/bin/env python3
"""
SURGICAL GHOST-TYPIST (Consolidated)
=====================================
Enterprise-grade UI automation for IBKR Gateway login.
Deterministic, strict timeouts, no brittle coordinates.

This script consolidates all Ghost-Typist logic to ensure
consistent behavior regardless of how it's called.
"""
...
class SurgicalGhostTypist:
    ...
    def execute_login(self) -> bool:
        ...
        try:
            ...
            # Step 4: Clear username field and inject username (NUCLEAR CLEAR)
            ...
            # Step 5: Clear password field and inject password (NUCLEAR CLEAR)
            ...
            # PORT GUARD: Script DOES NOT exit until port 7497 is reachable or timeout
